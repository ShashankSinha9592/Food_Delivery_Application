...
//    public ResponseEntity<ErrorDetails> feignExceptionHandler(FeignException exc, WebRequest req){
//
//        ErrorDetails errorDetails = new ErrorDetails();
//
//        errorDetails.setTimeSpan(LocalDateTime.now());
//        errorDetails.setMessage("Service is down, please try again after sometime");
//        errorDetails.setDescription(req.getDescription(false));
//
//        return new ResponseEntity<>(errorDetails, HttpStatus.SERVICE_UNAVAILABLE);
//
